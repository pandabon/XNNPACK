...
#define XNN_UNPREDICTABLE(condition) \
  (__builtin_expect_with_probability(!!(condition), 0, 0.5))
#else
...
#else
// XNN_ARCH_ARM, XNN_ARCH_ARM64, XNN_ARCH_WASM, XNN_ARCH_WASMSIMD,
// XNN_ARCH_WASMRELAXEDSIMD, XNN_ARCH_RISVC. Wasm/Scalar gavgpool microkernels
// can over-read by 4 buffers.
...
#if XNN_ARCH_ARM || XNN_ARCH_X86 || XNN_ARCH_X86_64 || XNN_ARCH_WASM || \
    XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
