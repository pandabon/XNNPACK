...
//   Specification: test/bf16-f32-igemm-minmax.yaml
...
namespace {
  ...
  INSTANTIATE_TEST_SUITE_P(
      BF16_F32_IGEMM_MINMAX_1X4V__RVV_ZVFBFMIN_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests1(
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_f32_igemm_minmax_ukernel_1x4v__rvv_zvfbfmin_zvfbfa,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_bf16_f32_conv_goki_w);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      BF16_F32_IGEMM_MINMAX_4X4V__RVV_ZVFBFMIN_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_f32_igemm_minmax_ukernel_4x4v__rvv_zvfbfmin_zvfbfa,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_bf16_f32_conv_goki_w);
          },
          xnn_arch_riscv_zvfbfa)),
