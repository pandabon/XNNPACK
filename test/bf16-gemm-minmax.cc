...
std::vector<GemmTestParams> CreateTests1(
...
#if XNN_ENABLE_RISCV_ZVFBFMIN && XNN_ARCH_RISCV
  // NOLINTNEXTLINE(clang-diagnostic-unused-function)
...
#endif  // XNN_ENABLE_RISCV_ZVFBFMIN && XNN_ARCH_RISCV
...
#if XNN_ENABLE_RISCV_ZVFBFMIN && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_1X4V__RVV_ZVFBFMIN, GemmTest,
      testing::ValuesIn(CreateTests2(
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_1x4v__rvv_zvfbfmin,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfmin)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
        return info.param.test_name;
      });

  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_4X4V__RVV_ZVFBFMIN, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_4x4v__rvv_zvfbfmin,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfmin)),
...
#if XNN_ENABLE_RISCV_ZVFBFA && XNN_ARCH_RISCV
  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_1X4V__RVV_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_1x4v__rvv_zvfbfa,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfa)),
      [](const testing::TestParamInfo<GemmTest::ParamType>& info) {
        return info.param.test_name;
      });

  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_4X4V__RVV_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_4x4v__rvv_zvfbfa,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfa)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_1X4V__RVV_ZVFBFMIN_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/1, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_1x4v__rvv_zvfbfmin_zvfbfa,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfa)),
  ...
  INSTANTIATE_TEST_SUITE_P(
      BF16_GEMM_MINMAX_4X4V__RVV_ZVFBFMIN_ZVFBFA, GemmTest,
      testing::ValuesIn(CreateTests2(
          /*k_block=*/1,
          /*adj_k_block=*/1,
          /*mr=*/4, /*nr=*/4, /*kr=*/1, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_bf16_gemm_minmax_ukernel_4x4v__rvv_zvfbfmin_zvfbfa,
                        xnn_init_bf16_minmax_scalar_params,
                        xnn_pack_bf16_f32_gemm_goi_w);
          },
          xnn_arch_riscv_zvfbfa)),
...
#endif  // XNN_ENABLE_RISCV_ZVFBFA && XNN_ARCH_RISCV
